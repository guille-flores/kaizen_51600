import {Box, Grid, Stack, Button, Select, FormControl, InputLabel, MenuItem, SelectChangeEvent} from '@mui/material'
    ...
    return (
        ...
        >
            ...
            <Grid container spacing={2} border={2} sx={{backgroundColor: "#81c784"}}>
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }}>
                        ...
                        <FormControl  md={3} fullWidth>
                            ...
                            >
                                ...
                                <Link to="/servicios/psicoanalisis">
                                    <MenuItem>Psicoanalisis</MenuItem>
                                </Link>
                                <Link to="/servicios/terapia de parejas">
                                    <MenuItem>Terapia de Parejas</MenuItem>
                                </Link>
                                <Link to="/servicios/cognitivo conductual">
                                    <MenuItem>Cognitivo Conductual</MenuItem>
                                </Link>
                            </Select>
                        </FormControl>
                ...
                <Grid item sx={{ display: { xs: 'inline', sm: 'none' }}} xs={12}>
                    <FormControl  md={3} fullWidth>
                        <InputLabel id="demo-simple-select-label" size="small" >
                            <Button md={3} variant="text" href="/servicios" fullWidth={true}>MENÚ</Button>
                        </InputLabel>
